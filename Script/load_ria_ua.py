...
def get_mongo_collection(collection_name):
    """
    Підключення к MongoDB и повертання коллекції.
    URI и пароль з  перемених оточення.
    """
    ...
    print(f"Підключено к коллекції: {collection_name}")
...
def load_trailers_by_bodystyle(
    ...
    """
    ЗЗавантаження даних зі списка  bodystyles за вказаний ік та квартал.
    результат логування у колекції log_col (MongoDB).
